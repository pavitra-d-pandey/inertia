...
`)+`
`+h);const _=v+m+s,w=v+h+o,P=Hm(r,r.VERTEX_SHADER,_),C=Hm(r,r.FRAGMENT_SHADER,w);r.attachShader(x,P),r.attachShader(x,C),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function M(R){if(t.debug.checkShaderErrors){const z=r.getProgramInfoLog(x).trim(),I=r.getShaderInfoLog(P).trim(),D=r.getShaderInfoLog(C).trim();let B=!0,H=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(B=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,P,C);else{const $=Gm(r,P,"vertex"),k=Gm(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
}`;class FA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,i){if(this.texture===null){const r=new rn,a=e.properties.get(r);a.__webglTexture=n.texture,(n.depthNear!=i.depthNear||n.depthFar!=i.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new xi({vertexShader:UA,fragmentShader:kA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new Xn(new Qs(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class OA extends Va{constructor(e,n){super();const i=this;let r=null,a=1,s=null,o="local-floor",l=1,u=null,d=null,f=null,p=null,g=null,y=null;const x=new FA,m=n.getContextAttributes();let h=null,v=null;const _=[],w=[],P=new Ve;let C=null;const M=new Dn;M.layers.enable(1),M.viewport=new Nt;const E=new Dn;E.layers.enable(2),E.viewport=new Nt;const S=[M,E],b=new DA;b.layers.enable(1),b.layers.enable(2);let R=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(V){let Y=_[V];return Y===void 0&&(Y=new Tu,_[V]=Y),Y.getTargetRaySpace()},this.getControllerGrip=function(V){let Y=_[V];return Y===void 0&&(Y=new Tu,_[V]=Y),Y.getGripSpace()},this.getHand=function(V){let Y=_[V];return Y===void 0&&(Y=new Tu,_[V]=Y),Y.getHandSpace()};function I(V){const Y=w.indexOf(V.inputSource);if(Y===-1)return;const ne=_[Y];ne!==void 0&&(ne.update(V.inputSource,V.frame,u||s),ne.dispatchEvent({type:V.type,data:V.inputSource}))}function D(){r.removeEventListener("select",I),r.removeEventListener("selectstart",I),r.removeEventListener("selectend",I),r.removeEventListener("squeeze",I),r.removeEventListener("squeezestart",I),r.removeEventListener("squeezeend",I),r.removeEventListener("end",D),r.removeEventListener("inputsourceschange",B);for(let V=0;V<_.length;V++){const Y=w[V];Y!==null&&(w[V]=null,_[V].disconnect(Y))}R=null,z=null,x.reset(),e.setRenderTarget(h),g=null,p=null,f=null,r=null,v=null,ue.stop(),i.isPresenting=!1,e.setPixelRatio(C),e.setSize(P.width,P.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(V){a=V,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(V){o=V,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||s},this.setReferenceSpace=function(V){u=V},this.getBaseLayer=function(){return p!==null?p:g},this.getBinding=function(){return f},this.getFrame=function(){return y},this.getSession=function(){return r},this.setSession=async function(V){if(r=V,r!==null){if(h=e.getRenderTarget(),r.addEventListener("select",I),r.addEventListener("selectstart",I),r.addEventListener("selectend",I),r.addEventListener("squeeze",I),r.addEventListener("squeezestart",I),r.addEventListener("squeezeend",I),r.addEventListener("end",D),r.addEventListener("inputsourceschange",B),m.xrCompatible!==!0&&await n.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(P),r.renderState.layers===void 0){const Y={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:a};g=new XRWebGLLayer(r,n,Y),r.updateRenderState({baseLayer:g}),e.setPixelRatio(1),e.setSize(g.framebufferWidth,g.framebufferHeight,!1),v=new Pr(g.framebufferWidth,g.framebufferHeight,{format:kn,type:yi,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil})}else{let Y=null,ne=null,se=null;m.depth&&(se=m.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,Y=m.stencil?ka:wa,ne=m.stencil?Ua:Rr);const be={colorFormat:n.RGBA8,depthFormat:se,scaleFactor:a};f=new XRWebGLBinding(r,n),p=f.createProjectionLayer(be),r.updateRenderState({layers:[p]}),e.setPixelRatio(1),e.setSize(p.textureWidth,p.textureHeight,!1),v=new Pr(p.textureWidth,p.textureHeight,{format:kn,type:yi,depthTexture:new fx(p.textureWidth,p.textureHeight,ne,void 0,void 0,void 0,void 0,void 0,void 0,Y),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:p.ignoreDepthValues===!1})}v.isXRRenderTarget=!0,this.setFoveation(l),u=null,s=await r.requestReferenceSpace(o),ue.setContext(r),ue.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function B(V){for(let Y=0;Y<V.removed.length;Y++){const ne=V.removed[Y],se=w.indexOf(ne);se>=0&&(w[se]=null,_[se].disconnect(ne))}for(let Y=0;Y<V.added.length;Y++){const ne=V.added[Y];let se=w.indexOf(ne);if(se===-1){for(let we=0;we<_.length;we++)if(we>=w.length){w.push(ne),se=we;break}else if(w[we]===null){w[we]=ne,se=we;break}if(se===-1)break}const be=_[se];be&&be.connect(ne)}}const H=new W,$=new W;function k(V,Y,ne){H.setFromMatrixPosition(Y.matrixWorld),$.setFromMatrixPosition(ne.matrixWorld);const se=H.distanceTo($),be=Y.projectionMatrix.elements,we=ne.projectionMatrix.elements,Ae=be[14]/(be[10]-1),qe=be[14]/(be[10]+1),L=(be[9]+1)/be[5],dt=(be[9]-1)/be[5],Xe=(be[8]-1)/be[0],$e=(we[8]+1)/we[0],Me=Ae*Xe,yt=Ae*$e,De=se/(-Xe+$e),Ue=De*-Xe;Y.matrixWorld.decompose(V.position,V.quaternion,V.scale),V.translateX(Ue),V.translateZ(De),V.matrixWorld.compose(V.position,V.quaternion,V.scale),V.matrixWorldInverse.copy(V.matrixWorld).invert();const N=Ae+De,T=qe+De,X=Me-Ue,te=yt+(se-Ue),re=L*qe/T*N,ee=dt*qe/T*N;V.projectionMatrix.makePerspective(X,te,re,ee,N,T),V.projectionMatrixInverse.copy(V.projectionMatrix).invert()}function K(V,Y){Y===null?V.matrixWorld.copy(V.matrix):V.matrixWorld.multiplyMatrices(Y.matrixWorld,V.matrix),V.matrixWorldInverse.copy(V.matrixWorld).invert()}this.updateCamera=function(V){if(r===null)return;x.texture!==null&&(V.near=x.depthNear,V.far=x.depthFar),b.near=E.near=M.near=V.near,b.far=E.far=M.far=V.far,(R!==b.near||z!==b.far)&&(r.updateRenderState({depthNear:b.near,depthFar:b.far}),R=b.near,z=b.far,M.near=R,M.far=z,E.near=R,E.far=z,M.updateProjectionMatrix(),E.updateProjectionMatrix(),V.updateProjectionMatrix());const Y=V.parent,ne=b.cameras;K(b,Y);for(let se=0;se<ne.length;se++)K(ne[se],Y);ne.length===2?k(b,M,E):b.projectionMatrix.copy(M.projectionMatrix),J(V,b,Y)};function J(V,Y,ne){ne===null?V.matrix.copy(Y.matrixWorld):(V.matrix.copy(ne.matrixWorld),V.matrix.invert(),V.matrix.multiply(Y.matrixWorld)),V.matrix.decompose(V.position,V.quaternion,V.scale),V.updateMatrixWorld(!0),V.projectionMatrix.copy(Y.projectionMatrix),V.projectionMatrixInverse.copy(Y.projectionMatrixInverse),V.isPerspectiveCamera&&(V.fov=oh*2*Math.atan(1/V.projectionMatrix.elements[5]),V.zoom=1)}this.getCamera=function(){return b},this.getFoveation=function(){if(!(p===null&&g===null))return l},this.setFoveation=function(V){l=V,p!==null&&(p.fixedFoveation=V),g!==null&&g.fixedFoveation!==void 0&&(g.fixedFoveation=V)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(b)};let ae=null;function xe(V,Y){if(d=Y.getViewerPose(u||s),y=Y,d!==null){const ne=d.views;g!==null&&(e.setRenderTargetFramebuffer(v,g.framebuffer),e.setRenderTarget(v));let se=!1;ne.length!==b.cameras.length&&(b.cameras.length=0,se=!0);for(let we=0;we<ne.length;we++){const Ae=ne[we];let qe=null;if(g!==null)qe=g.getViewport(Ae);else{const dt=f.getViewSubImage(p,Ae);qe=dt.viewport,we===0&&(e.setRenderTargetTextures(v,dt.colorTexture,p.ignoreDepthValues?void 0:dt.depthStencilTexture),e.setRenderTarget(v))}let L=S[we];L===void 0&&(L=new Dn,L.layers.enable(we),L.viewport=new Nt,S[we]=L),L.matrix.fromArray(Ae.transform.matrix),L.matrix.decompose(L.position,L.quaternion,L.scale),L.projectionMatrix.fromArray(Ae.projectionMatrix),L.projectionMatrixInverse.copy(L.projectionMatrix).invert(),L.viewport.set(qe.x,qe.y,qe.width,qe.height),we===0&&(b.matrix.copy(L.matrix),b.matrix.decompose(b.position,b.quaternion,b.scale)),se===!0&&b.cameras.push(L)}const be=r.enabledFeatures;if(be&&be.includes("depth-sensing")){const we=f.getDepthInformation(ne[0]);we&&we.isValid&&we.texture&&x.init(e,we,r.renderState)}}for(let ne=0;ne<_.length;ne++){const se=w[ne],be=_[ne];se!==null&&be!==void 0&&be.update(se,Y,u||s)}ae&&ae(V,Y),Y.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:Y}),y=null}const ue=new dx;ue.setAnimationLoop(xe),this.setAnimationLoop=function(V){ae=V},this.dispose=function(){}}}const cr=new vi,zA=new Et;function BA(t,e){function n(m,h){m.matrixAutoUpdate===!0&&m.updateMatrix(),h.value.copy(m.matrix)}function i(m,h){h.color.getRGB(m.fogColor.value,ox(t)),h.isFog?(m.fogNear.value=h.near,m.fogFar.value=h.far):h.isFogExp2&&(m.fogDensity.value=h.density)}function r(m,h,v,_,w){h.isMeshBasicMaterial||h.isMeshLambertMaterial?a(m,h):h.isMeshToonMaterial?(a(m,h),f(m,h)):h.isMeshPhongMaterial?(a(m,h),d(m,h)):h.isMeshStandardMaterial?(a(m,h),p(m,h),h.isMeshPhysicalMaterial&&g(m,h,w)):h.isMeshMatcapMaterial?(a(m,h),y(m,h)):h.isMeshDepthMaterial?a(m,h):h.isMeshDistanceMaterial?(a(m,h),x(m,h)):h.isMeshNormalMaterial?a(m,h):h.isLineBasicMaterial?(s(m,h),h.isLineDashedMaterial&&o(m,h)):h.isPointsMaterial?l(m,h,v,_):h.isSpriteMaterial?u(m,h):h.isShadowMaterial?(m.color.value.copy(h.color),m.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function a(m,h){m.opacity.value=h.opacity,h.color&&m.diffuse.value.copy(h.color),h.emissive&&m.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(m.map.value=h.map,n(h.map,m.mapTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,n(h.alphaMap,m.alphaMapTransform)),h.bumpMap&&(m.bumpMap.value=h.bumpMap,n(h.bumpMap,m.bumpMapTransform),m.bumpScale.value=h.bumpScale,h.side===nn&&(m.bumpScale.value*=-1)),h.normalMap&&(m.normalMap.value=h.normalMap,n(h.normalMap,m.normalMapTransform),m.normalScale.value.copy(h.normalScale),h.side===nn&&m.normalScale.value.negate()),h.displacementMap&&(m.displacementMap.value=h.displacementMap,n(h.displacementMap,m.displacementMapTransform),m.displacementScale.value=h.displacementScale,m.displacementBias.value=h.displacementBias),h.emissiveMap&&(m.emissiveMap.value=h.emissiveMap,n(h.emissiveMap,m.emissiveMapTransform)),h.specularMap&&(m.specularMap.value=h.specularMap,n(h.specularMap,m.specularMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest);const v=e.get(h),_=v.envMap,w=v.envMapRotation;_&&(m.envMap.value=_,cr.copy(w),cr.x*=-1,cr.y*=-1,cr.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(cr.y*=-1,cr.z*=-1),m.envMapRotation.value.setFromMatrix4(zA.makeRotationFromEuler(cr)),m.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=h.reflectivity,m.ior.value=h.ior,m.refractionRatio.value=h.refractionRatio),h.lightMap&&(m.lightMap.value=h.lightMap,m.lightMapIntensity.value=h.lightMapIntensity,n(h.lightMap,m.lightMapTransform)),h.aoMap&&(m.aoMap.value=h.aoMap,m.aoMapIntensity.value=h.aoMapIntensity,n(h.aoMap,m.aoMapTransform))}function s(m,h){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,h.map&&(m.map.value=h.map,n(h.map,m.mapTransform))}function o(m,h){m.dashSize.value=h.dashSize,m.totalSize.value=h.dashSize+h.gapSize,m.scale.value=h.scale}function l(m,h,v,_){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,m.size.value=h.size*v,m.scale.value=_*.5,h.map&&(m.map.value=h.map,n(h.map,m.uvTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,n(h.alphaMap,m.alphaMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest)}function u(m,h){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,m.rotation.value=h.rotation,h.map&&(m.map.value=h.map,n(h.map,m.mapTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,n(h.alphaMap,m.alphaMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest)}function d(m,h){m.specular.value.copy(h.specular),m.shininess.value=Math.max(h.shininess,1e-4)}function f(m,h){h.gradientMap&&(m.gradientMap.value=h.gradientMap)}function p(m,h){m.metalness.value=h.metalness,h.metalnessMap&&(m.metalnessMap.value=h.metalnessMap,n(h.metalnessMap,m.metalnessMapTransform)),m.roughness.value=h.roughness,h.roughnessMap&&(m.roughnessMap.value=h.roughnessMap,n(h.roughnessMap,m.roughnessMapTransform)),h.envMap&&(m.envMapIntensity.value=h.envMapIntensity)}function g(m,h,v){m.ior.value=h.ior,h.sheen>0&&(m.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),m.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(m.sheenColorMap.value=h.sheenColorMap,n(h.sheenColorMap,m.sheenColorMapTransform)),h.sheenRoughnessMap&&(m.sheenRoughnessMap.value=h.sheenRoughnessMap,n(h.sheenRoughnessMap,m.sheenRoughnessMapTransform))),h.clearcoat>0&&(m.clearcoat.value=h.clearcoat,m.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(m.clearcoatMap.value=h.clearcoatMap,n(h.clearcoatMap,m.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,n(h.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(m.clearcoatNormalMap.value=h.clearcoatNormalMap,n(h.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===nn&&m.clearcoatNormalScale.value.negate())),h.dispersion>0&&(m.dispersion.value=h.dispersion),h.iridescence>0&&(m.iridescence.value=h.iridescence,m.iridescenceIOR.value=h.iridescenceIOR,m.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(m.iridescenceMap.value=h.iridescenceMap,n(h.iridescenceMap,m.iridescenceMapTransform)),h.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=h.iridescenceThicknessMap,n(h.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),h.transmission>0&&(m.transmission.value=h.transmission,m.transmissionSamplerMap.value=v.texture,m.transmissionSamplerSize.value.set(v.width,v.height),h.transmissionMap&&(m.transmissionMap.value=h.transmissionMap,n(h.transmissionMap,m.transmissionMapTransform)),m.thickness.value=h.thickness,h.thicknessMap&&(m.thicknessMap.value=h.thicknessMap,n(h.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=h.attenuationDistance,m.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(m.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(m.anisotropyMap.value=h.anisotropyMap,n(h.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=h.specularIntensity,m.specularColor.value.copy(h.specularColor),h.specularColorMap&&(m.specularColorMap.value=h.specularColorMap,n(h.specularColorMap,m.specularColorMapTransform)),h.specularIntensityMap&&(m.specularIntensityMap.value=h.specularIntensityMap,n(h.specularIntensityMap,m.specularIntensityMapTransform))}function y(m,h){h.matcap&&(m.matcap.value=h.matcap)}function x(m,h){const v=e.get(h).light;m.referencePosition.value.setFromMatrixPosition(v.matrixWorld),m.nearDistance.value=v.shadow.camera.near,m.farDistance.value=v.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function jA(t,e,n,i){let r={},a={},s=[];const o=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(v,_){const w=_.program;i.uniformBlockBinding(v,w)}function u(v,_){let w=r[v.id];w===void 0&&(y(v),w=d(v),r[v.id]=w,v.addEventListener("dispose",m));const P=_.program;i.updateUBOMapping(v,P);const C=e.render.frame;a[v.id]!==C&&(p(v),a[v.id]=C)}function d(v){const _=f();v.__bindingPointIndex=_;const w=t.createBuffer(),P=v.__size,C=v.usage;return t.bindBuffer(t.UNIFORM_BUFFER,w),t.bufferData(t.UNIFORM_BUFFER,P,C),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,_,w),w}function f(){for(let v=0;v<o;v++)if(s.indexOf(v)===-1)return s.push(v),v;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function p(v){const _=r[v.id],w=v.uniforms,P=v.__cache;t.bindBuffer(t.UNIFORM_BUFFER,_);for(let C=0,M=w.length;C<M;C++){const E=Array.isArray(w[C])?w[C]:[w[C]];for(let S=0,b=E.length;S<b;S++){const R=E[S];if(g(R,C,S,P)===!0){const z=R.__offset,I=Array.isArray(R.value)?R.value:[R.value];let D=0;for(let B=0;B<I.length;B++){const H=I[B],$=x(H);typeof H=="number"||typeof H=="boolean"?(R.__data[0]=H,t.bufferSubData(t.UNIFORM_BUFFER,z+D,R.__data)):H.isMatrix3?(R.__data[0]=H.elements[0],R.__data[1]=H.elements[1],R.__data[2]=H.elements[2],R.__data[3]=0,R.__data[4]=H.elements[3],R.__data[5]=H.elements[4],R.__data[6]=H.elements[5],R.__data[7]=0,R.__data[8]=H.elements[6],R.__data[9]=H.elements[7],R.__data[10]=H.elements[8],R.__data[11]=0):(H.toArray(R.__data,D),D+=$.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,z,R.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function g(v,_,w,P){const C=v.value,M=_+"_"+w;if(P[M]===void 0)return typeof C=="number"||typeof C=="boolean"?P[M]=C:P[M]=C.clone(),!0;{const E=P[M];if(typeof C=="number"||typeof C=="boolean"){if(E!==C)return P[M]=C,!0}else if(E.equals(C)===!1)return E.copy(C),!0}return!1}function y(v){const _=v.uniforms;let w=0;const P=16;for(let M=0,E=_.length;M<E;M++){const S=Array.isArray(_[M])?_[M]:[_[M]];for(let b=0,R=S.length;b<R;b++){const z=S[b],I=Array.isArray(z.value)?z.value:[z.value];for(let D=0,B=I.length;D<B;D++){const H=I[D],$=x(H),k=w%P,K=k%$.boundary,J=k+K;w+=K,J!==0&&P-J<$.storage&&(w+=P-J),z.__data=new Float32Array($.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=w,w+=$.storage}}}const C=w%P;return C>0&&(w+=P-C),v.__size=w,v.__cache={},this}function x(v){const _={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(_.boundary=4,_.storage=4):v.isVector2?(_.boundary=8,_.storage=8):v.isVector3||v.isColor?(_.boundary=16,_.storage=12):v.isVector4?(_.boundary=16,_.storage=16):v.isMatrix3?(_.boundary=48,_.storage=48):v.isMatrix4?(_.boundary=64,_.storage=64):v.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",v),_}function m(v){const _=v.target;_.removeEventListener("dispose",m);const w=s.indexOf(_.__bindingPointIndex);s.splice(w,1),t.deleteBuffer(r[_.id]),delete r[_.id],delete a[_.id]}function h(){for(const v in r)t.deleteBuffer(r[v]);s=[],r={},a={}}return{bind:l,update:u,dispose:h}}class VA{constructor(e={}){const{canvas:n=NM(),context:i=null,depth:r=!0,stencil:a=!1,alpha:s=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:f=!1}=e;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=s;const g=new Uint32Array(4),y=new Int32Array(4);let x=null,m=null;const h=[],v=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Hn,this.toneMapping=$i,this.toneMappingExposure=1;const _=this;let w=!1,P=0,C=0,M=null,E=-1,S=null;const b=new Nt,R=new Nt;let z=null;const I=new tt(0);let D=0,B=n.width,H=n.height,$=1,k=null,K=null;const J=new Nt(0,0,B,H),ae=new Nt(0,0,B,H);let xe=!1;const ue=new ux;let V=!1,Y=!1;const ne=new Et,se=new W,be=new Nt,we={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ae=!1;function qe(){return M===null?$:1}let L=i;function dt(A,O){return n.getContext(A,O)}try{const A={alpha:!0,depth:r,stencil:a,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:f};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${sf}`),n.addEventListener("webglcontextlost",Z,!1),n.addEventListener("webglcontextrestored",Q,!1),n.addEventListener("webglcontextcreationerror",de,!1),L===null){const O="webgl2";if(L=dt(O,A),L===null)throw dt(O)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw console.error("THREE.WebGLRenderer: "+A.message),A}let Xe,$e,Me,yt,De,Ue,N,T,X,te,re,ee,Ce,fe,ye,ke,oe,ge,He,Ie,ve,Le,Be,ot;function F(){Xe=new $1(L),Xe.init(),Le=new IA(L,Xe),$e=new V1(L,Xe,e,Le),Me=new RA(L),yt=new Z1(L),De=new mA,Ue=new NA(L,Xe,Me,De,$e,Le,yt),N=new G1(_),T=new X1(_),X=new rE(L),Be=new B1(L,X),te=new Y1(L,X,yt,Be),re=new Q1(L,te,X,yt),He=new J1(L,$e,Ue),ke=new H1(De),ee=new pA(_,N,T,Xe,$e,Be,ke),Ce=new BA(_,De),fe=new yA,ye=new wA(Xe),ge=new z1(_,N,T,Me,re,p,l),oe=new AA(_,re,$e),ot=new jA(L,yt,$e,Me),Ie=new j1(L,Xe,yt),ve=new K1(L,Xe,yt),yt.programs=ee.programs,_.capabilities=$e,_.extensions=Xe,_.properties=De,_.renderLists=fe,_.shadowMap=oe,_.state=Me,_.info=yt}F();const le=new OA(_,L);this.xr=le,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){const A=Xe.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=Xe.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return $},this.setPixelRatio=function(A){A!==void 0&&($=A,this.setSize(B,H,!1))},this.getSize=function(A){return A.set(B,H)},this.setSize=function(A,O,G=!0){if(le.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}B=A,H=O,n.width=Math.floor(A*$),n.height=Math.floor(O*$),G===!0&&(n.style.width=A+"px",n.style.height=O+"px"),this.setViewport(0,0,A,O)},this.getDrawingBufferSize=function(A){return A.set(B*$,H*$).floor()},this.setDrawingBufferSize=function(A,O,G){B=A,H=O,$=G,n.width=Math.floor(A*G),n.height=Math.floor(O*G),this.setViewport(0,0,A,O)},this.getCurrentViewport=function(A){return A.copy(b)},this.getViewport=function(A){return A.copy(J)},this.setViewport=function(A,O,G,q){A.isVector4?J.set(A.x,A.y,A.z,A.w):J.set(A,O,G,q),Me.viewport(b.copy(J).multiplyScalar($).round())},this.getScissor=function(A){return A.copy(ae)},this.setScissor=function(A,O,G,q){A.isVector4?ae.set(A.x,A.y,A.z,A.w):ae.set(A,O,G,q),Me.scissor(R.copy(ae).multiplyScalar($).round())},this.getScissorTest=function(){return xe},this.setScissorTest=function(A){Me.setScissorTest(xe=A)},this.setOpaqueSort=function(A){k=A},this.setTransparentSort=function(A){K=A},this.getClearColor=function(A){return A.copy(ge.getClearColor())},this.setClearColor=function(){ge.setClearColor.apply(ge,arguments)},this.getClearAlpha=function(){return ge.getClearAlpha()},this.setClearAlpha=function(){ge.setClearAlpha.apply(ge,arguments)},this.clear=function(A=!0,O=!0,G=!0){let q=0;if(A){let j=!1;if(M!==null){const ce=M.texture.format;j=ce===hf||ce===df||ce===uf}if(j){const ce=M.texture.type,pe=ce===yi||ce===Rr||ce===js||ce===Ua||ce===lf||ce===cf,_e=ge.getClearColor(),Se=ge.getClearAlpha(),Pe=_e.r,Ne=_e.g,Te=_e.b;pe?(g[0]=Pe,g[1]=Ne,g[2]=Te,g[3]=Se,L.clearBufferuiv(L.COLOR,0,g)):(y[0]=Pe,y[1]=Ne,y[2]=Te,y[3]=Se,L.clearBufferiv(L.COLOR,0,y))}else q|=L.COLOR_BUFFER_BIT}O&&(q|=L.DEPTH_BUFFER_BIT),G&&(q|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),L.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",Z,!1),n.removeEventListener("webglcontextrestored",Q,!1),n.removeEventListener("webglcontextcreationerror",de,!1),fe.dispose(),ye.dispose(),De.dispose(),N.dispose(),T.dispose(),re.dispose(),Be.dispose(),ot.dispose(),ee.dispose(),le.dispose(),le.removeEventListener("sessionstart",Bn),le.removeEventListener("sessionend",yf),ir.stop()};function Z(A){A.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),w=!0}function Q(){console.log("THREE.WebGLRenderer: Context Restored."),w=!1;const A=yt.autoReset,O=oe.enabled,G=oe.autoUpdate,q=oe.needsUpdate,j=oe.type;F(),yt.autoReset=A,oe.enabled=O,oe.autoUpdate=G,oe.needsUpdate=q,oe.type=j}function de(A){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function Re(A){const O=A.target;O.removeEventListener("dispose",Re),Ge(O)}function Ge(A){vt(A),De.remove(A)}function vt(A){const O=De.get(A).programs;O!==void 0&&(O.forEach(function(G){ee.releaseProgram(G)}),A.isShaderMaterial&&ee.releaseShaderCache(A))}this.renderBufferDirect=function(A,O,G,q,j,ce){O===null&&(O=we);const pe=j.isMesh&&j.matrixWorld.determinant()<0,_e=wx(A,O,G,q,j);Me.setMaterial(q,pe);let Se=G.index,Pe=1;if(q.wireframe===!0){if(Se=te.getWireframeAttribute(G),Se===void 0)return;Pe=2}const Ne=G.drawRange,Te=G.attributes.position;let Ke=Ne.start*Pe,ht=(Ne.start+Ne.count)*Pe;ce!==null&&(Ke=Math.max(Ke,ce.start*Pe),ht=Math.min(ht,(ce.start+ce.count)*Pe)),Se!==null?(Ke=Math.max(Ke,0),ht=Math.min(ht,Se.count)):Te!=null&&(Ke=Math.max(Ke,0),ht=Math.min(ht,Te.count));const ft=ht-Ke;if(ft<0||ft===1/0)return;Be.setup(j,q,_e,G,Se);let an,Ze=Ie;if(Se!==null&&(an=X.get(Se),Ze=ve,Ze.setIndex(an)),j.isMesh)q.wireframe===!0?(Me.setLineWidth(q.wireframeLinewidth*qe()),Ze.setMode(L.LINES)):Ze.setMode(L.TRIANGLES);else if(j.isLine){let Ee=q.linewidth;Ee===void 0&&(Ee=1),Me.setLineWidth(Ee*qe()),j.isLineSegments?Ze.setMode(L.LINES):j.isLineLoop?Ze.setMode(L.LINE_LOOP):Ze.setMode(L.LINE_STRIP)}else j.isPoints?Ze.setMode(L.POINTS):j.isSprite&&Ze.setMode(L.TRIANGLES);if(j.isBatchedMesh)if(j._multiDrawInstances!==null)Ze.renderMultiDrawInstances(j._multiDrawStarts,j._multiDrawCounts,j._multiDrawCount,j._multiDrawInstances);else if(Xe.get("WEBGL_multi_draw"))Ze.renderMultiDraw(j._multiDrawStarts,j._multiDrawCounts,j._multiDrawCount);else{const Ee=j._multiDrawStarts,Lt=j._multiDrawCounts,Je=j._multiDrawCount,En=Se?X.get(Se).bytesPerElement:1,kr=De.get(q).currentProgram.getUniforms();for(let sn=0;sn<Je;sn++)kr.setValue(L,"_gl_DrawID",sn),Ze.render(Ee[sn]/En,Lt[sn])}else if(j.isInstancedMesh)Ze.renderInstances(Ke,ft,j.count);else if(G.isInstancedBufferGeometry){const Ee=G._maxInstanceCount!==void 0?G._maxInstanceCount:1/0,Lt=Math.min(G.instanceCount,Ee);Ze.renderInstances(Ke,ft,Lt)}else Ze.render(Ke,ft)};function Dt(A,O,G){A.transparent===!0&&A.side===si&&A.forceSinglePass===!1?(A.side=nn,A.needsUpdate=!0,to(A,O,G),A.side=Zi,A.needsUpdate=!0,to(A,O,G),A.side=si):to(A,O,G)}this.compile=function(A,O,G=null){G===null&&(G=A),m=ye.get(G),m.init(O),v.push(m),G.traverseVisible(function(j){j.isLight&&j.layers.test(O.layers)&&(m.pushLight(j),j.castShadow&&m.pushShadow(j))}),A!==G&&A.traverseVisible(function(j){j.isLight&&j.layers.test(O.layers)&&(m.pushLight(j),j.castShadow&&m.pushShadow(j))}),m.setupLights();const q=new Set;return A.traverse(function(j){const ce=j.material;if(ce)if(Array.isArray(ce))for(let pe=0;pe<ce.length;pe++){const _e=ce[pe];Dt(_e,G,j),q.add(_e)}else Dt(ce,G,j),q.add(ce)}),v.pop(),m=null,q},this.compileAsync=function(A,O,G=null){const q=this.compile(A,O,G);return new Promise(j=>{function ce(){if(q.forEach(function(pe){De.get(pe).currentProgram.isReady()&&q.delete(pe)}),q.size===0){j(A);return}setTimeout(ce,10)}Xe.get("KHR_parallel_shader_compile")!==null?ce():setTimeout(ce,10)})};let Ye=null;function Zn(A){Ye&&Ye(A)}function Bn(){ir.stop()}function yf(){ir.start()}const ir=new dx;ir.setAnimationLoop(Zn),typeof self<"u"&&ir.setContext(self),this.setAnimationLoop=function(A){Ye=A,le.setAnimationLoop(A),A===null?ir.stop():ir.start()},le.addEventListener("sessionstart",Bn),le.addEventListener("sessionend",yf),this.render=function(A,O){if(O!==void 0&&O.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),le.enabled===!0&&le.isPresenting===!0&&(le.cameraAutoUpdate===!0&&le.updateCamera(O),O=le.getCamera()),A.isScene===!0&&A.onBeforeRender(_,A,O,M),m=ye.get(A,v.length),m.init(O),v.push(m),ne.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),ue.setFromProjectionMatrix(ne),Y=this.localClippingEnabled,V=ke.init(this.clippingPlanes,Y),x=fe.get(A,h.length),x.init(),h.push(x),le.enabled===!0&&le.isPresenting===!0){const ce=_.xr.getDepthSensingMesh();ce!==null&&xc(ce,O,-1/0,_.sortObjects)}xc(A,O,0,_.sortObjects),x.finish(),_.sortObjects===!0&&x.sort(k,K),Ae=le.enabled===!1||le.isPresenting===!1||le.hasDepthSensing()===!1,Ae&&ge.addToRenderList(x,A),this.info.render.frame++,V===!0&&ke.beginShadows();const G=m.state.shadowsArray;oe.render(G,A,O),V===!0&&ke.endShadows(),this.info.autoReset===!0&&this.info.reset();const q=x.opaque,j=x.transmissive;if(m.setupLights(),O.isArrayCamera){const ce=O.cameras;if(j.length>0)for(let pe=0,_e=ce.length;pe<_e;pe++){const Se=ce[pe];xf(q,j,A,Se)}Ae&&ge.render(A);for(let pe=0,_e=ce.length;pe<_e;pe++){const Se=ce[pe];vf(x,A,Se,Se.viewport)}}else j.length>0&&xf(q,j,A,O),Ae&&ge.render(A),vf(x,A,O);M!==null&&(Ue.updateMultisampleRenderTarget(M),Ue.updateRenderTargetMipmap(M)),A.isScene===!0&&A.onAfterRender(_,A,O),Be.resetDefaultState(),E=-1,S=null,v.pop(),v.length>0?(m=v[v.length-1],V===!0&&ke.setGlobalState(_.clippingPlanes,m.state.camera)):m=null,h.pop(),h.length>0?x=h[h.length-1]:x=null};function xc(A,O,G,q){if(A.visible===!1)return;if(A.layers.test(O.layers)){if(A.isGroup)G=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(O);else if(A.isLight)m.pushLight(A),A.castShadow&&m.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||ue.intersectsSprite(A)){q&&be.setFromMatrixPosition(A.matrixWorld).applyMatrix4(ne);const pe=re.update(A),_e=A.material;_e.visible&&x.push(A,pe,_e,G,be.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||ue.intersectsObject(A))){const pe=re.update(A),_e=A.material;if(q&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),be.copy(A.boundingSphere.center)):(pe.boundingSphere===null&&pe.computeBoundingSphere(),be.copy(pe.boundingSphere.center)),be.applyMatrix4(A.matrixWorld).applyMatrix4(ne)),Array.isArray(_e)){const Se=pe.groups;for(let Pe=0,Ne=Se.length;Pe<Ne;Pe++){const Te=Se[Pe],Ke=_e[Te.materialIndex];Ke&&Ke.visible&&x.push(A,pe,Ke,G,be.z,Te)}}else _e.visible&&x.push(A,pe,_e,G,be.z,null)}}const ce=A.children;for(let pe=0,_e=ce.length;pe<_e;pe++)xc(ce[pe],O,G,q)}function vf(A,O,G,q){const j=A.opaque,ce=A.transmissive,pe=A.transparent;m.setupLightsView(G),V===!0&&ke.setGlobalState(_.clippingPlanes,G),q&&Me.viewport(b.copy(q)),j.length>0&&eo(j,O,G),ce.length>0&&eo(ce,O,G),pe.length>0&&eo(pe,O,G),Me.buffers.depth.setTest(!0),Me.buffers.depth.setMask(!0),Me.buffers.color.setMask(!0),Me.setPolygonOffset(!1)}function xf(A,O,G,q){if((G.isScene===!0?G.overrideMaterial:null)!==null)return;m.state.transmissionRenderTarget[q.id]===void 0&&(m.state.transmissionRenderTarget[q.id]=new Pr(1,1,{generateMipmaps:!0,type:Xe.has("EXT_color_buffer_half_float")||Xe.has("EXT_color_buffer_float")?$s:yi,minFilter:_r,samples:4,stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Qe.workingColorSpace}));const ce=m.state.transmissionRenderTarget[q.id],pe=q.viewport||b;ce.setSize(pe.z,pe.w);const _e=_.getRenderTarget();_.setRenderTarget(ce),_.getClearColor(I),D=_.getClearAlpha(),D<1&&_.setClearColor(16777215,.5),_.clear(),Ae&&ge.render(G);const Se=_.toneMapping;_.toneMapping=$i;const Pe=q.viewport;if(q.viewport!==void 0&&(q.viewport=void 0),m.setupLightsView(q),V===!0&&ke.setGlobalState(_.clippingPlanes,q),eo(A,G,q),Ue.updateMultisampleRenderTarget(ce),Ue.updateRenderTargetMipmap(ce),Xe.has("WEBGL_multisampled_render_to_texture")===!1){let Ne=!1;for(let Te=0,Ke=O.length;Te<Ke;Te++){const ht=O[Te],ft=ht.object,an=ht.geometry,Ze=ht.material,Ee=ht.group;if(Ze.side===si&&ft.layers.test(q.layers)){const Lt=Ze.side;Ze.side=nn,Ze.needsUpdate=!0,_f(ft,G,q,an,Ze,Ee),Ze.side=Lt,Ze.needsUpdate=!0,Ne=!0}}Ne===!0&&(Ue.updateMultisampleRenderTarget(ce),Ue.updateRenderTargetMipmap(ce))}_.setRenderTarget(_e),_.setClearColor(I,D),Pe!==void 0&&(q.viewport=Pe),_.toneMapping=Se}function eo(A,O,G){const q=O.isScene===!0?O.overrideMaterial:null;for(let j=0,ce=A.length;j<ce;j++){const pe=A[j],_e=pe.object,Se=pe.geometry,Pe=q===null?pe.material:q,Ne=pe.group;_e.layers.test(G.layers)&&_f(_e,O,G,Se,Pe,Ne)}}function _f(A,O,G,q,j,ce){A.onBeforeRender(_,O,G,q,j,ce),A.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),j.transparent===!0&&j.side===si&&j.forceSinglePass===!1?(j.side=nn,j.needsUpdate=!0,_.renderBufferDirect(G,O,q,j,A,ce),j.side=Zi,j.needsUpdate=!0,_.renderBufferDirect(G,O,q,j,A,ce),j.side=si):_.renderBufferDirect(G,O,q,j,A,ce),A.onAfterRender(_,O,G,q,j,ce)}function to(A,O,G){O.isScene!==!0&&(O=we);const q=De.get(A),j=m.state.lights,ce=m.state.shadowsArray,pe=j.state.version,_e=ee.getParameters(A,j.state,ce,O,G),Se=ee.getProgramCacheKey(_e);let Pe=q.programs;q.environment=A.isMeshStandardMaterial?O.environment:null,q.fog=O.fog,q.envMap=(A.isMeshStandardMaterial?T:N).get(A.envMap||q.environment),q.envMapRotation=q.environment!==null&&A.envMap===null?O.environmentRotation:A.envMapRotation,Pe===void 0&&(A.addEventListener("dispose",Re),Pe=new Map,q.programs=Pe);let Ne=Pe.get(Se);if(Ne!==void 0){if(q.currentProgram===Ne&&q.lightsStateVersion===pe)return bf(A,_e),Ne}else _e.uniforms=ee.getUniforms(A),A.onBeforeCompile(_e,_),Ne=ee.acquireProgram(_e,Se),Pe.set(Se,Ne),q.uniforms=_e.uniforms;const Te=q.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Te.clippingPlanes=ke.uniform),bf(A,_e),q.needsLights=Ex(A),q.lightsStateVersion=pe,q.needsLights&&(Te.ambientLightColor.value=j.state.ambient,Te.lightProbe.value=j.state.probe,Te.directionalLights.value=j.state.directional,Te.directionalLightShadows.value=j.state.directionalShadow,Te.spotLights.value=j.state.spot,Te.spotLightShadows.value=j.state.spotShadow,Te.rectAreaLights.value=j.state.rectArea,Te.ltc_1.value=j.state.rectAreaLTC1,Te.ltc_2.value=j.state.rectAreaLTC2,Te.pointLights.value=j.state.point,Te.pointLightShadows.value=j.state.pointShadow,Te.hemisphereLights.value=j.state.hemi,Te.directionalShadowMap.value=j.state.directionalShadowMap,Te.directionalShadowMatrix.value=j.state.directionalShadowMatrix,Te.spotShadowMap.value=j.state.spotShadowMap,Te.spotLightMatrix.value=j.state.spotLightMatrix,Te.spotLightMap.value=j.state.spotLightMap,Te.pointShadowMap.value=j.state.pointShadowMap,Te.pointShadowMatrix.value=j.state.pointShadowMatrix),q.currentProgram=Ne,q.uniformsList=null,Ne}function Sf(A){if(A.uniformsList===null){const O=A.currentProgram.getUniforms();A.uniformsList=cl.seqWithValue(O.seq,A.uniforms)}return A.uniformsList}function bf(A,O){const G=De.get(A);G.outputColorSpace=O.outputColorSpace,G.batching=O.batching,G.batchingColor=O.batchingColor,G.instancing=O.instancing,G.instancingColor=O.instancingColor,G.instancingMorph=O.instancingMorph,G.skinning=O.skinning,G.morphTargets=O.morphTargets,G.morphNormals=O.morphNormals,G.morphColors=O.morphColors,G.morphTargetsCount=O.morphTargetsCount,G.numClippingPlanes=O.numClippingPlanes,G.numIntersection=O.numClipIntersection,G.vertexAlphas=O.vertexAlphas,G.vertexTangents=O.vertexTangents,G.toneMapping=O.toneMapping}function wx(A,O,G,q,j){O.isScene!==!0&&(O=we),Ue.resetTextureUnits();const ce=O.fog,pe=q.isMeshStandardMaterial?O.environment:null,_e=M===null?_.outputColorSpace:M.isXRRenderTarget===!0?M.texture.colorSpace:nr,Se=(q.isMeshStandardMaterial?T:N).get(q.envMap||pe),Pe=q.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,Ne=!!G.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),Te=!!G.morphAttributes.position,Ke=!!G.morphAttributes.normal,ht=!!G.morphAttributes.color;let ft=$i;q.toneMapped&&(M===null||M.isXRRenderTarget===!0)&&(ft=_.toneMapping);const an=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,Ze=an!==void 0?an.length:0,Ee=De.get(q),Lt=m.state.lights;if(V===!0&&(Y===!0||A!==S)){const gn=A===S&&q.id===E;ke.setState(q,A,gn)}let Je=!1;q.version===Ee.__version?(Ee.needsLights&&Ee.lightsStateVersion!==Lt.state.version||Ee.outputColorSpace!==_e||j.isBatchedMesh&&Ee.batching===!1||!j.isBatchedMesh&&Ee.batching===!0||j.isBatchedMesh&&Ee.batchingColor===!0&&j.colorTexture===null||j.isBatchedMesh&&Ee.batchingColor===!1&&j.colorTexture!==null||j.isInstancedMesh&&Ee.instancing===!1||!j.isInstancedMesh&&Ee.instancing===!0||j.isSkinnedMesh&&Ee.skinning===!1||!j.isSkinnedMesh&&Ee.skinning===!0||j.isInstancedMesh&&Ee.instancingColor===!0&&j.instanceColor===null||j.isInstancedMesh&&Ee.instancingColor===!1&&j.instanceColor!==null||j.isInstancedMesh&&Ee.instancingMorph===!0&&j.morphTexture===null||j.isInstancedMesh&&Ee.instancingMorph===!1&&j.morphTexture!==null||Ee.envMap!==Se||q.fog===!0&&Ee.fog!==ce||Ee.numClippingPlanes!==void 0&&(Ee.numClippingPlanes!==ke.numPlanes||Ee.numIntersection!==ke.numIntersection)||Ee.vertexAlphas!==Pe||Ee.vertexTangents!==Ne||Ee.morphTargets!==Te||Ee.morphNormals!==Ke||Ee.morphColors!==ht||Ee.toneMapping!==ft||Ee.morphTargetsCount!==Ze)&&(Je=!0):(Je=!0,Ee.__version=q.version);let En=Ee.currentProgram;Je===!0&&(En=to(q,O,j));let kr=!1,sn=!1,_c=!1;const xt=En.getUniforms(),Si=Ee.uniforms;if(Me.useProgram(En.program)&&(kr=!0,sn=!0,_c=!0),q.id!==E&&(E=q.id,sn=!0),kr||S!==A){xt.setValue(L,"projectionMatrix",A.projectionMatrix),xt.setValue(L,"viewMatrix",A.matrixWorldInverse);const gn=xt.map.cameraPosition;gn!==void 0&&gn.setValue(L,se.setFromMatrixPosition(A.matrixWorld)),$e.logarithmicDepthBuffer&&xt.setValue(L,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&xt.setValue(L,"isOrthographic",A.isOrthographicCamera===!0),S!==A&&(S=A,sn=!0,_c=!0)}if(j.isSkinnedMesh){xt.setOptional(L,j,"bindMatrix"),xt.setOptional(L,j,"bindMatrixInverse");const gn=j.skeleton;gn&&(gn.boneTexture===null&&gn.computeBoneTexture(),xt.setValue(L,"boneTexture",gn.boneTexture,Ue))}j.isBatchedMesh&&(xt.setOptional(L,j,"batchingTexture"),xt.setValue(L,"batchingTexture",j._matricesTexture,Ue),xt.setOptional(L,j,"batchingIdTexture"),xt.setValue(L,"batchingIdTexture",j._indirectTexture,Ue),xt.setOptional(L,j,"batchingColorTexture"),j._colorsTexture!==null&&xt.setValue(L,"batchingColorTexture",j._colorsTexture,Ue));const Sc=G.morphAttributes;if((Sc.position!==void 0||Sc.normal!==void 0||Sc.color!==void 0)&&He.update(j,G,En),(sn||Ee.receiveShadow!==j.receiveShadow)&&(Ee.receiveShadow=j.receiveShadow,xt.setValue(L,"receiveShadow",j.receiveShadow)),q.isMeshGouraudMaterial&&q.envMap!==null&&(Si.envMap.value=Se,Si.flipEnvMap.value=Se.isCubeTexture&&Se.isRenderTargetTexture===!1?-1:1),q.isMeshStandardMaterial&&q.envMap===null&&O.environment!==null&&(Si.envMapIntensity.value=O.environmentIntensity),sn&&(xt.setValue(L,"toneMappingExposure",_.toneMappingExposure),Ee.needsLights&&Mx(Si,_c),ce&&q.fog===!0&&Ce.refreshFogUniforms(Si,ce),Ce.refreshMaterialUniforms(Si,q,$,H,m.state.transmissionRenderTarget[A.id]),cl.upload(L,Sf(Ee),Si,Ue)),q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(cl.upload(L,Sf(Ee),Si,Ue),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&xt.setValue(L,"center",j.center),xt.setValue(L,"modelViewMatrix",j.modelViewMatrix),xt.setValue(L,"normalMatrix",j.normalMatrix),xt.setValue(L,"modelMatrix",j.matrixWorld),q.isShaderMaterial||q.isRawShaderMaterial){const gn=q.uniformsGroups;for(let bc=0,Cx=gn.length;bc<Cx;bc++){const wf=gn[bc];ot.update(wf,En),ot.bind(wf,En)}}return En}function Mx(A,O){A.ambientLightColor.needsUpdate=O,A.lightProbe.needsUpdate=O,A.directionalLights.needsUpdate=O,A.directionalLightShadows.needsUpdate=O,A.pointLights.needsUpdate=O,A.pointLightShadows.needsUpdate=O,A.spotLights.needsUpdate=O,A.spotLightShadows.needsUpdate=O,A.rectAreaLights.needsUpdate=O,A.hemisphereLights.needsUpdate=O}function Ex(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return M},this.setRenderTargetTextures=function(A,O,G){De.get(A.texture).__webglTexture=O,De.get(A.depthTexture).__webglTexture=G;const q=De.get(A);q.__hasExternalTextures=!0,q.__autoAllocateDepthBuffer=G===void 0,q.__autoAllocateDepthBuffer||Xe.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),q.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(A,O){const G=De.get(A);G.__webglFramebuffer=O,G.__useDefaultFramebuffer=O===void 0},this.setRenderTarget=function(A,O=0,G=0){M=A,P=O,C=G;let q=!0,j=null,ce=!1,pe=!1;if(A){const Se=De.get(A);Se.__useDefaultFramebuffer!==void 0?(Me.bindFramebuffer(L.FRAMEBUFFER,null),q=!1):Se.__webglFramebuffer===void 0?Ue.setupRenderTarget(A):Se.__hasExternalTextures&&Ue.rebindTextures(A,De.get(A.texture).__webglTexture,De.get(A.depthTexture).__webglTexture);const Pe=A.texture;(Pe.isData3DTexture||Pe.isDataArrayTexture||Pe.isCompressedArrayTexture)&&(pe=!0);const Ne=De.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(Ne[O])?j=Ne[O][G]:j=Ne[O],ce=!0):A.samples>0&&Ue.useMultisampledRTT(A)===!1?j=De.get(A).__webglMultisampledFramebuffer:Array.isArray(Ne)?j=Ne[G]:j=Ne,b.copy(A.viewport),R.copy(A.scissor),z=A.scissorTest}else b.copy(J).multiplyScalar($).floor(),R.copy(ae).multiplyScalar($).floor(),z=xe;if(Me.bindFramebuffer(L.FRAMEBUFFER,j)&&q&&Me.drawBuffers(A,j),Me.viewport(b),Me.scissor(R),Me.setScissorTest(z),ce){const Se=De.get(A.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+O,Se.__webglTexture,G)}else if(pe){const Se=De.get(A.texture),Pe=O||0;L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,Se.__webglTexture,G||0,Pe)}E=-1},this.readRenderTargetPixels=function(A,O,G,q,j,ce,pe){if(!(A&&A.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let _e=De.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&pe!==void 0&&(_e=_e[pe]),_e){Me.bindFramebuffer(L.FRAMEBUFFER,_e);try{const Se=A.texture,Pe=Se.format,Ne=Se.type;if(!$e.textureFormatReadable(Pe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!$e.textureTypeReadable(Ne)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=A.width-q&&G>=0&&G<=A.height-j&&L.readPixels(O,G,q,j,Le.convert(Pe),Le.convert(Ne),ce)}finally{const Se=M!==null?De.get(M).__webglFramebuffer:null;Me.bindFramebuffer(L.FRAMEBUFFER,Se)}}},this.readRenderTargetPixelsAsync=async function(A,O,G,q,j,ce,pe){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let _e=De.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&pe!==void 0&&(_e=_e[pe]),_e){Me.bindFramebuffer(L.FRAMEBUFFER,_e);try{const Se=A.texture,Pe=Se.format,Ne=Se.type;if(!$e.textureFormatReadable(Pe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!$e.textureTypeReadable(Ne))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(O>=0&&O<=A.width-q&&G>=0&&G<=A.height-j){const Te=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,Te),L.bufferData(L.PIXEL_PACK_BUFFER,ce.byteLength,L.STREAM_READ),L.readPixels(O,G,q,j,Le.convert(Pe),Le.convert(Ne),0),L.flush();const Ke=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);await IM(L,Ke,4);try{L.bindBuffer(L.PIXEL_PACK_BUFFER,Te),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,ce)}finally{L.deleteBuffer(Te),L.deleteSync(Ke)}return ce}}finally{const Se=M!==null?De.get(M).__webglFramebuffer:null;Me.bindFramebuffer(L.FRAMEBUFFER,Se)}}},this.copyFramebufferToTexture=function(A,O=null,G=0){A.isTexture!==!0&&(_s("WebGLRenderer: copyFramebufferToTexture function signature has changed."),O=arguments[0]||null,A=arguments[1]);const q=Math.pow(2,-G),j=Math.floor(A.image.width*q),ce=Math.floor(A.image.height*q),pe=O!==null?O.x:0,_e=O!==null?O.y:0;Ue.setTexture2D(A,0),L.copyTexSubImage2D(L.TEXTURE_2D,G,0,0,pe,_e,j,ce),Me.unbindTexture()},this.copyTextureToTexture=function(A,O,G=null,q=null,j=0){A.isTexture!==!0&&(_s("WebGLRenderer: copyTextureToTexture function signature has changed."),q=arguments[0]||null,A=arguments[1],O=arguments[2],j=arguments[3]||0,G=null);let ce,pe,_e,Se,Pe,Ne;G!==null?(ce=G.max.x-G.min.x,pe=G.max.y-G.min.y,_e=G.min.x,Se=G.min.y):(ce=A.image.width,pe=A.image.height,_e=0,Se=0),q!==null?(Pe=q.x,Ne=q.y):(Pe=0,Ne=0);const Te=Le.convert(O.format),Ke=Le.convert(O.type);Ue.setTexture2D(O,0),L.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,O.flipY),L.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),L.pixelStorei(L.UNPACK_ALIGNMENT,O.unpackAlignment);const ht=L.getParameter(L.UNPACK_ROW_LENGTH),ft=L.getParameter(L.UNPACK_IMAGE_HEIGHT),an=L.getParameter(L.UNPACK_SKIP_PIXELS),Ze=L.getParameter(L.UNPACK_SKIP_ROWS),Ee=L.getParameter(L.UNPACK_SKIP_IMAGES),Lt=A.isCompressedTexture?A.mipmaps[j]:A.image;L.pixelStorei(L.UNPACK_ROW_LENGTH,Lt.width),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,Lt.height),L.pixelStorei(L.UNPACK_SKIP_PIXELS,_e),L.pixelStorei(L.UNPACK_SKIP_ROWS,Se),A.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,j,Pe,Ne,ce,pe,Te,Ke,Lt.data):A.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,j,Pe,Ne,Lt.width,Lt.height,Te,Lt.data):L.texSubImage2D(L.TEXTURE_2D,j,Pe,Ne,ce,pe,Te,Ke,Lt),L.pixelStorei(L.UNPACK_ROW_LENGTH,ht),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,ft),L.pixelStorei(L.UNPACK_SKIP_PIXELS,an),L.pixelStorei(L.UNPACK_SKIP_ROWS,Ze),L.pixelStorei(L.UNPACK_SKIP_IMAGES,Ee),j===0&&O.generateMipmaps&&L.generateMipmap(L.TEXTURE_2D),Me.unbindTexture()},this.copyTextureToTexture3D=function(A,O,G=null,q=null,j=0){A.isTexture!==!0&&(_s("WebGLRenderer: copyTextureToTexture3D function signature has changed."),G=arguments[0]||null,q=arguments[1]||null,A=arguments[2],O=arguments[3],j=arguments[4]||0);let ce,pe,_e,Se,Pe,Ne,Te,Ke,ht;const ft=A.isCompressedTexture?A.mipmaps[j]:A.image;G!==null?(ce=G.max.x-G.min.x,pe=G.max.y-G.min.y,_e=G.max.z-G.min.z,Se=G.min.x,Pe=G.min.y,Ne=G.min.z):(ce=ft.width,pe=ft.height,_e=ft.depth,Se=0,Pe=0,Ne=0),q!==null?(Te=q.x,Ke=q.y,ht=q.z):(Te=0,Ke=0,ht=0);const an=Le.convert(O.format),Ze=Le.convert(O.type);let Ee;if(O.isData3DTexture)Ue.setTexture3D(O,0),Ee=L.TEXTURE_3D;else if(O.isDataArrayTexture||O.isCompressedArrayTexture)Ue.setTexture2DArray(O,0),Ee=L.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}L.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,O.flipY),L.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),L.pixelStorei(L.UNPACK_ALIGNMENT,O.unpackAlignment);const Lt=L.getParameter(L.UNPACK_ROW_LENGTH),Je=L.getParameter(L.UNPACK_IMAGE_HEIGHT),En=L.getParameter(L.UNPACK_SKIP_PIXELS),kr=L.getParameter(L.UNPACK_SKIP_ROWS),sn=L.getParameter(L.UNPACK_SKIP_IMAGES);L.pixelStorei(L.UNPACK_ROW_LENGTH,ft.width),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,ft.height),L.pixelStorei(L.UNPACK_SKIP_PIXELS,Se),L.pixelStorei(L.UNPACK_SKIP_ROWS,Pe),L.pixelStorei(L.UNPACK_SKIP_IMAGES,Ne),A.isDataTexture||A.isData3DTexture?L.texSubImage3D(Ee,j,Te,Ke,ht,ce,pe,_e,an,Ze,ft.data):O.isCompressedArrayTexture?L.compressedTexSubImage3D(Ee,j,Te,Ke,ht,ce,pe,_e,an,ft.data):L.texSubImage3D(Ee,j,Te,Ke,ht,ce,pe,_e,an,Ze,ft),L.pixelStorei(L.UNPACK_ROW_LENGTH,Lt),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,Je),L.pixelStorei(L.UNPACK_SKIP_PIXELS,En),L.pixelStorei(L.UNPACK_SKIP_ROWS,kr),L.pixelStorei(L.UNPACK_SKIP_IMAGES,sn),j===0&&O.generateMipmaps&&L.generateMipmap(Ee),Me.unbindTexture()},this.initRenderTarget=function(A){De.get(A).__webglFramebuffer===void 0&&Ue.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?Ue.setTextureCube(A,0):A.isData3DTexture?Ue.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?Ue.setTexture2DArray(A,0):Ue.setTexture2D(A,0),Me.unbindTexture()},this.resetState=function(){P=0,C=0,M=null,Me.reset(),Be.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ui}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=e===ff?"display-p3":"srgb",n.unpackColorSpace=Qe.workingColorSpace===dc?"display-p3":"srgb"}}class HA extends hn{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new vi,this.environmentIntensity=1,this.environmentRotation=new vi,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(n.object.environmentIntensity=this.environmentIntensity),n.object.environmentRotation=this.environmentRotation.toArray(),n}}class GA{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=Qm(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const n=Qm();e=(n-this.oldTime)/1e3,this.oldTime=n,this.elapsedTime+=e}return e}}function Qm(){return(typeof performance>"u"?Date:performance).now()}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:sf}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=sf);const WA=`

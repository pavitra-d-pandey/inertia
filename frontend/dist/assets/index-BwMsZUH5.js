...
`)}),d.jsx("td",{children:E.createdAt})]},E.id))})]})})]}),d.jsxs("div",{className:"card",style:{marginTop:"22px"},children:[d.jsx("h4",{children:"Contact Submissions"}),d.jsx("div",{className:"table-wrap",children:d.jsxs("table",{className:"admin-table",children:[d.jsx("thead",{children:d.jsxs("tr",{children:[d.jsx("th",{children:"Email"}),d.jsx("th",{children:"Phone"}),d.jsx("th",{children:"Issue"}),d.jsx("th",{children:"Created"})]})}),d.jsx("tbody",{children:b.length===0?d.jsx("tr",{children:d.jsx("td",{colSpan:4,children:"No contact submissions yet."})}):b.map(E=>d.jsxs("tr",{children:[d.jsx("td",{children:E.email}),d.jsx("td",{children:E.phone}),d.jsx("td",{style:{whiteSpace:"pre-wrap",minWidth:"280px"},children:E.issue}),d.jsx("td",{children:E.createdAt})]},E.id))})]})})]}),d.jsxs("div",{className:"card",style:{marginTop:"22px"},children:[d.jsx("h4",{children:"Open Mic Registrations"}),d.jsx("div",{className:"table-wrap",children:d.jsxs("table",{className:"admin-table",children:[d.jsx("thead",{children:d.jsxs("tr",{children:[d.jsx("th",{children:"Name"}),d.jsx("th",{children:"Contact"}),d.jsx("th",{children:"Enrollment"}),d.jsx("th",{children:"Performance"}),d.jsx("th",{children:"Created"})]})}),d.jsx("tbody",{children:M.length===0?d.jsx("tr",{children:d.jsx("td",{colSpan:5,children:"No registrations yet."})}):M.map(E=>d.jsxs("tr",{children:[d.jsxs("td",{children:[d.jsx("strong",{children:E.name}),d.jsx("p",{children:E.collegeName})]}),d.jsx("td",{children:d.jsx("p",{children:E.phone})}),d.jsxs("td",{children:[d.jsx("p",{children:E.enrollmentNumber}),d.jsx("p",{children:E.year})]}),d.jsxs("td",{children:[d.jsx("p",{children:E.performanceType}),d.jsx("p",{children:E.scriptPdfUrl||"-"})]}),d.jsx("td",{children:E.createdAt})]},E.id))})]})})]})]}):d.jsxs("section",{className:"section",children:[d.jsx("h2",{className:"section-title",children:"Management Access - Registrations"}),d.jsxs("div",{className:"card",style:{maxWidth:"520px"},children:[d.jsx("h4",{children:"Enter Password"}),d.jsxs("form",{className:"form-grid",onSubmit:T,children:[d.jsx("input",{type:"password",placeholder:"Enter password",value:n,onChange:E=>i(E.target.value),required:!0}),d.jsx("button",{className:"btn btn-primary",type:"submit",children:"Unlock"})]}),r&&d.jsx("div",{className:"banner",style:{marginTop:"18px"},children:r})]})]})}function t2(){const[t,e]=O.useState(lf()),[n,i]=O.useState(""),[r,s]=O.useState(""),[a,o]=O.useState(!1),[l,c]=O.useState([]),[u,h]=O.useState([]),[p,g]=O.useState([]),v={"X-Admin-Token":xr()},_=async()=>{const[w,A,T]=await Promise.all([He("/api/admin/content/gallery",{headers:v}),He("/api/admin/content/team",{headers:v}),He("/api/admin/content/culture-events",{headers:v})]);c(Array.isArray(w)?w:[]),h(Array.isArray(A)?A:[]),g(Array.isArray(T)?T.map(S=>({...S,imageUrl:S.imageUrl||""})):[])};O.useEffect(()=>{t&&_().catch(()=>{s("Could not load content data.")})},[t]);const m=w=>{if(w.preventDefault(),!cf(n)){s("Wrong password.");return}s(""),i(""),e(!0)},f=async w=>{o(!0),s("");try{const A=await He(`/api/admin/glimpse/${w.id}`,{method:"PUT",headers:v,body:JSON.stringify({title:w.title,preview:w.preview,description:w.description,imageUrl:w.imageUrl})});s(A.message),await _()}catch(A){s(A instanceof Error?A.message:"Update failed")}finally{o(!1)}},y=async w=>{o(!0),s("");try{const A=await He(`/api/admin/glimpse/${w}`,{method:"DELETE",headers:v});s(A.message),await _()}catch(A){s(A instanceof Error?A.message:"Delete failed")}finally{o(!1)}},x=async w=>{o(!0),s("");try{const A=await He(`/api/admin/team/${w.id}`,{method:"PUT",headers:v,body:JSON.stringify({name:w.name,role:w.role,preview:w.preview,about:w.about,imageUrl:w.imageUrl})});s(A.message),await _()}catch(A){s(A instanceof Error?A.message:"Update failed")}finally{o(!1)}},M=async w=>{o(!0),s("");try{const A=await He(`/api/admin/team/${w}`,{method:"DELETE",headers:v});s(A.message),await _()}catch(A){s(A instanceof Error?A.message:"Delete failed")}finally{o(!1)}},P=async w=>{o(!0),s("");try{const A=await He(`/api/admin/culture-event/${w.id}`,{method:"PUT",headers:v,body:JSON.stringify({title:w.title,preview:w.preview,description:w.description,imageUrl:w.imageUrl})});s(A.message),await _()}catch(A){s(A instanceof Error?A.message:"Update failed")}finally{o(!1)}},b=async w=>{o(!0),s("");try{const A=await He(`/api/admin/culture-event/${w}`,{method:"DELETE",headers:v});s(A.message),await _()}catch(A){s(A instanceof Error?A.message:"Delete failed")}finally{o(!1)}};return t?d.jsxs("section",{className:"section",children:[d.jsx("h2",{className:"section-title",children:"Content Manager"}),d.jsx("p",{className:"section-subtitle",children:"Edit or delete any uploaded gallery, team, or cultural content."}),d.jsx("div",{className:"admin-links",children:d.jsx(Wt,{className:"btn btn-ghost",to:"/secret-admin",children:"Back To Content Upload Panel"})}),d.jsxs("div",{className:"card",style:{marginTop:"22px"},children:[d.jsx("h4",{children:"Gallery Items"}),l.length===0?d.jsx("p",{children:"No gallery items."}):l.map((w,A)=>d.jsx("div",{className:"card",style:{marginTop:A===0?"0":"16px"},children:d.jsxs("div",{className:"form-grid",children:[d.jsx("input",{value:w.title,onChange:T=>c(S=>S.map(E=>E.id===w.id?{...E,title:T.target.value}:E))}),d.jsx("input",{value:w.preview,onChange:T=>c(S=>S.map(E=>E.id===w.id?{...E,preview:T.target.value}:E))}),d.jsx("textarea",{rows:3,value:w.description,onChange:T=>c(S=>S.map(E=>E.id===w.id?{...E,description:T.target.value}:E))}),d.jsx("input",{value:w.imageUrl,onChange:T=>c(S=>S.map(E=>E.id===w.id?{...E,imageUrl:T.target.value}:E))}),d.jsxs("div",{className:"admin-links",children:[d.jsx("button",{className:"btn btn-primary",type:"button",disabled:a,onClick:()=>f(w),children:"Save"}),d.jsx("button",{className:"btn btn-ghost",type:"button",disabled:a,onClick:()=>y(w.id),children:"Delete"})]})]})},w.id))]}),d.jsxs("div",{className:"card",style:{marginTop:"22px"},children:[d.jsx("h4",{children:"Team Members"}),u.length===0?d.jsx("p",{children:"No team members."}):u.map((w,A)=>d.jsx("div",{className:"card",style:{marginTop:A===0?"0":"16px"},children:d.jsxs("div",{className:"form-grid",children:[d.jsx("input",{value:w.name,onChange:T=>h(S=>S.map(E=>E.id===w.id?{...E,name:T.target.value}:E))}),d.jsx("input",{value:w.role,onChange:T=>h(S=>S.map(E=>E.id===w.id?{...E,role:T.target.value}:E))}),d.jsx("input",{value:w.preview,onChange:T=>h(S=>S.map(E=>E.id===w.id?{...E,preview:T.target.value}:E))}),d.jsx("textarea",{rows:3,value:w.about,onChange:T=>h(S=>S.map(E=>E.id===w.id?{...E,about:T.target.value}:E))}),d.jsx("input",{value:w.imageUrl,onChange:T=>h(S=>S.map(E=>E.id===w.id?{...E,imageUrl:T.target.value}:E))}),d.jsxs("div",{className:"admin-links",children:[d.jsx("button",{className:"btn btn-primary",type:"button",disabled:a,onClick:()=>x(w),children:"Save"}),d.jsx("button",{className:"btn btn-ghost",type:"button",disabled:a,onClick:()=>M(w.id),children:"Delete"})]})]})},w.id))]}),d.jsxs("div",{className:"card",style:{marginTop:"22px"},children:[d.jsx("h4",{children:"Cultural Events"}),p.length===0?d.jsx("p",{children:"No cultural events."}):p.map((w,A)=>d.jsx("div",{className:"card",style:{marginTop:A===0?"0":"16px"},children:d.jsxs("div",{className:"form-grid",children:[d.jsx("input",{value:w.title,onChange:T=>g(S=>S.map(E=>E.id===w.id?{...E,title:T.target.value}:E))}),d.jsx("input",{value:w.preview,onChange:T=>g(S=>S.map(E=>E.id===w.id?{...E,preview:T.target.value}:E))}),d.jsx("textarea",{rows:3,value:w.description,onChange:T=>g(S=>S.map(E=>E.id===w.id?{...E,description:T.target.value}:E))}),d.jsx("input",{value:w.imageUrl||"",onChange:T=>g(S=>S.map(E=>E.id===w.id?{...E,imageUrl:T.target.value}:E))}),d.jsxs("div",{className:"admin-links",children:[d.jsx("button",{className:"btn btn-primary",type:"button",disabled:a,onClick:()=>P(w),children:"Save"}),d.jsx("button",{className:"btn btn-ghost",type:"button",disabled:a,onClick:()=>b(w.id),children:"Delete"})]})]})},w.id))]}),r&&d.jsx("div",{className:"banner",style:{marginTop:"18px"},children:r})]}):d.jsxs("section",{className:"section",children:[d.jsx("h2",{className:"section-title",children:"Management Access - Content Manager"}),d.jsxs("div",{className:"card",style:{maxWidth:"520px"},children:[d.jsx("h4",{children:"Enter Password"}),d.jsxs("form",{className:"form-grid",onSubmit:m,children:[d.jsx("input",{type:"password",placeholder:"Enter password",value:n,onChange:w=>i(w.target.value),required:!0}),d.jsx("button",{className:"btn btn-primary",type:"submit",children:"Unlock"})]}),r&&d.jsx("div",{className:"banner",style:{marginTop:"18px"},children:r})]})]})}function n2(){return d.jsxs("section",{className:"section",children:[d.jsx("h2",{className:"section-title",children:"Page Not Found"}),d.jsx("p",{className:"section-subtitle",children:"This page does not exist."}),d.jsx("a",{className:"btn btn-primary",href:"/",children:"Back to Home"})]})}function i2(){return O.useEffect(()=>{document.documentElement.dataset.theme="dark"},[]),d.jsxs("div",{className:"app-shell",children:[d.jsx(OR,{}),d.jsx(FR,{}),d.jsx(qS,{}),d.jsx("main",{className:"app-content",children:d.jsxs(LS,{children:[d.jsx(It,{path:"/",element:d.jsx(zR,{})}),d.jsx(It,{path:"/register",element:d.jsx(XR,{})}),d.jsx(It,{path:"/hackathon",element:d.jsx(VR,{})}),d.jsx(It,{path:"/workshops",element:d.jsx(jR,{})}),d.jsx(It,{path:"/kinetic-showdown",element:d.jsx(Zm,{})}),d.jsx(It,{path:"/robo-race",element:d.jsx(Zm,{})}),d.jsx(It,{path:"/esports",element:d.jsx(GR,{})}),d.jsx(It,{path:"/open-mic",element:d.jsx(WR,{})}),d.jsx(It,{path:"/culture",element:d.jsx(qR,{})}),d.jsx(It,{path:"/gallery",element:d.jsx($R,{})}),d.jsx(It,{path:"/team",element:d.jsx(YR,{})}),d.jsx(It,{path:"/contact",element:d.jsx(KR,{})}),d.jsx(It,{path:"/secret-admin",element:d.jsx(ZR,{})}),d.jsx(It,{path:"/secret-admin/registrations",element:d.jsx(e2,{})}),d.jsx(It,{path:"/secret-admin/manage-content",element:d.jsx(t2,{})}),d.jsx(It,{path:"*",element:d.jsx(n2,{})})]})}),d.jsx($S,{})]})}yu.createRoot(document.getElementById("root")).render(d.jsx(cg.StrictMode,{children:d.jsx(BS,{future:{v7_startTransition:!0,v7_relativeSplatPath:!0},children:d.jsx(i2,{})})}));
